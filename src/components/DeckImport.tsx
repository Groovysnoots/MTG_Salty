    ...
    <div className="space-y-4 rounded-xl border border-zinc-800/80 bg-zinc-900/50 p-5">
      ...
      {mode === "url" ? (
        <input
          ...
          className="w-full rounded-xl border border-zinc-700/80 bg-zinc-800/60 px-4 py-3 text-sm text-zinc-100 placeholder-zinc-500 outline-none transition-all focus:border-amber-500/70 focus:ring-2 focus:ring-amber-500/20"
        />
      ) : (
        <textarea
          value={text}
          ...
          rows={8}
          className="w-full rounded-xl border border-zinc-700/80 bg-zinc-800/60 px-4 py-3 font-mono text-sm text-zinc-100 placeholder-zinc-500 outline-none transition-all focus:border-amber-500/70 focus:ring-2 focus:ring-amber-500/20"
        />
      )}
      ...
      <button
        ...
        className="w-full rounded-xl bg-amber-600 px-4 py-2.5 text-sm font-semibold text-white transition-all hover:bg-amber-500 disabled:cursor-not-allowed disabled:opacity-50 sm:w-auto"
      >
        {isLoading ? (
